...
class BaseModel:
    ...
    # def id(self, value):
    #     """
    #     Setter method for id, do nothing
    ...
    # def created_at(self):
    #     """
    #     Returns the date created of the object (Getter)
    ...
    #     """
    #     Setter for create date, does not change create date
    ...
    # def updated_at(self):
    #     """
    #     Returns the date updated of the object (Getter)
    ...
    #         None
    #     """
    #     self.date_validator("date", value)
    #     self
